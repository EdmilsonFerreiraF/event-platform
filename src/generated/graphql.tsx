...
export type LessonFragmentFragment = { __typename?: 'Lesson', title: string, videoId: string, description?: string | null, teacher?: { __typename?: 'Teacher', name: string, bio: string, avatarURL: string } | null };
...
export type LessonSummaryFragment = { __typename?: 'Lesson', id: string, lessonType: LessonType, availableAt?: any | null, title: string, slug?: string | null };
...
export type SubscriberIdFragment = { __typename?: 'Subscriber', id: string };
...
export const LessonFragmentFragmentDoc = gql`
  ...
  teacher {
    ...
    `;
export const LessonSummaryFragmentDoc = gql`
  ...
  slug
    ...
    `;
export const SubscriberIdFragmentDoc = gql`
